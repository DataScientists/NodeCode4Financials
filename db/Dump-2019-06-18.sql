...
LOCK TABLES `AppFile` WRITE;
/*!40000 ALTER TABLE `AppFile` DISABLE KEYS */;
INSERT INTO `AppFile` VALUES (1,'/file/','YarkayPIDump20190610.sql',NULL,NULL,NULL),(2,'/file/','user_outgoing-admin-20190618132733.csv',0,NULL,NULL),(3,'/file/','Untitled design.jpg',0,NULL,NULL);
/*!40000 ALTER TABLE `AppFile` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-06-18 23:31:20
